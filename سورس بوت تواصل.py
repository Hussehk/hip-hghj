...
b3kkk = Client("Channel - B3KKK",api_id=14170449,api_hash="03488b3c030fe095667e7ca22fe34954",bot_token="6246284893:AAEObqaZGgDVuW1qa3s9mWS6wrDtiZcx6L0")
...
async def START(c:Client,m:Message):
	...
	ارسل رسالتك وسيتم الرد عليك قريبا
		...
		con.commit()
		try:
			await b3kkk.send_message(5565674333,f"""
		<u>«**New User**»</u>
...
@b3kkk.on_message(filters.command("تفعيل التواصل","") & filters.user(5565674333) & filters.private)
...
@b3kkk.on_message(filters.command("تعطيل التواصل","") & filters.user(5565674333) & filters.private)
...
@b3kkk.on_message(filters.command("الاحصائيات","") & filters.user(5565674333) & filters.private)
...
@b3kkk.on_message(filters.command("اذاعه للكل","") & filters.user(5565674333) & filters.private)
...
@b3kkk.on_message(filters.command("حظر عضو","") & filters.user(5565674333) & filters.private)
...
@b3kkk.on_message(filters.command("الغاء حظر عضو","") & filters.user(5565674333) & filters.private)
...
@b3kkk.on_message(filters.private & ~filters.command("start") & ~filters.user(5565674333))
async def Private(c:Client,m:Message):
	...
	if CHECK_BAND(user_id=m.from_user.id):
		...
		await b3kkk.copy_message(chat_id=5565674333,
